          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
                ...
                development. We believe that education is the most powerful tool
                for creating lasting positive change in society.
              </p>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Through Deban Academy, we're building a foundation for the next
                generation while empowering local communities with knowledge,
                skills, and opportunities for a brighter future.
              </p>
              <Link to="/contact">
            ...
            >
              ...
              <div className="bg-card rounded-2xl p-8 shadow-brand border border-border">
                <div className="bg-muted/50 rounded-xl p-6">
                  ...
                  <p className="text-primary font-medium mt-4">— John Dewey</p>
                </div>
              </div>
            </motion.div>
          </div>
