  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-br from-primary/80 via-primary/75 to-secondary/70"
        />
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold text-white mb-8 leading-tight drop-shadow-lg">
                ...
                <span className="inline-grid grid-cols-3 gap-1 mr-4 align-middle">
                  {[...Array(9)].map((_, i) => (
                    <span key={i} className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-white"></span>
                  ))}
                </span>
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
                Deban Infomatrix is a strategy-led consulting and operations company delivering performance frameworks, customer engagement solutions, and financial product distribution to institutions and consumers.
              </p>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                We operate across Management Consulting, Portfolio Risk & Recovery Modelling, Owned Contact Center Operations, and Sales of Financial Products (Loans & Insurance)—combining intelligence, analytics, and execution to create sustainable growth.
              </p>
              <motion.div
