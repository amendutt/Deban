...
const Services = () => {
  const managementConsulting = {
    ...
    icon: Target,
    description:
      "OKR & CFR design, performance frameworks, process consulting",
  ...
  const portfolioModelling = {
    ...
    icon: BarChart3,
    description: "Early-stage portfolio strategies, analytics-driven engagement models",
  ...
  const contactCenter = {
    ...
    icon: Headphones,
    description: "Outbound & inbound engagement, CX, voice-bot enabled workflows",
  ...
  const financialProducts = {
    ...
    icon: Banknote,
    description: "Loans & insurance sourcing through assisted and digital channels",
    products: [
      ...
      <section className="py-12 md:py-16 relative overflow-hidden">
        <div className="container-wide relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
            {[
              { icon: Target, title: "Management Consulting", desc: "OKR & CFR design, performance frameworks, process consulting" },
              { icon: BarChart3, title: "Portfolio Risk & Recovery", desc: "Early-stage portfolio strategies, analytics-driven engagement models" },
              { icon: Headphones, title: "Contact Center Operations", desc: "Outbound & inbound engagement, CX, voice-bot enabled workflows" },
              { icon: Banknote, title: "Financial Product Sales", desc: "Loans & insurance sourcing through assisted and digital channels" },
            ].map((pillar, idx) => (
              <motion.div
                key={pillar.title}
              ...
              >
                ...
                <p className="text-foreground text-xs leading-relaxed">{pillar.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
                ...
                {contactCenter.operations.map((item) => (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-foreground/80 to-transparent flex items-end p-2">
                      <span className="text-background text-xs font-medium">{item.text}</span>
                    </div>
                  </motion.div>
                ))}
              </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <p className="text-foreground text-lg mb-6">
                Deban Infomatrix is actively engaged in sales and distribution of financial products, working as a sourcing and engagement partner.
              </p>
              <p className="text-foreground font-semibold mb-6">
                Outcome: Scalable, ethical, and conversion-focused financial product distribution.
              </p>
            ...
            >
              ...
              <div className="bg-card rounded-2xl p-6 shadow-brand border border-border">
                <h4 className="font-semibold text-foreground mb-4">Products Covered</h4>
              ...
              {/* Sales Channels */}
              <div className="bg-card rounded-2xl p-6 shadow-brand border border-border">
                <h4 className="font-semibold text-foreground mb-4">Sales Channels</h4>
                <ul className="space-y-2">
